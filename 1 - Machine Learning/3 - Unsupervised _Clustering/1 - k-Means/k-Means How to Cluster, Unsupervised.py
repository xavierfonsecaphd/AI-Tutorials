"""
    ...
    Use scikit-learn's K-Means Clustering to cluster data -> one of the simplest
    clustering algorithms. Despite its simplicity, the K-means is vastly used 
    for clustering in many data science applications, especially useful if you 
    ...
    In this code we practice k-means clustering with 2 examples:
...
##############################################################################
"""
    The first example is the usage of clustering on a randomly created dataset.
    For an actual dataset, scroll down and ignore this example
"""
# We need a seed. Use numpy's random.seed() function, where the seed will be set to 0
np.random.seed(0)

"""
    Next we will be making random clusters of points by using the make_blobs 
    class. The make_blobs class can take in many inputs, but we will be using 
    these specific ones.
...
##############################################################################
#############        Initialization of the k-Means Model           ###########
##############################################################################
"""
Now that we have our random data, let's set up our K-Means Clustering.
    ...
    init:       Initialization method of the centroids.
                    Value will be: "k-means++". k-means++: Selects initial 
                    cluster centers for k-mean clustering in a smart way to 
    ...
    n_init:     Number of time the k-means algorithm will be run with different 
                    centroid seeds. The final results will be the best output 
...
##############################################################################
#############            k-Means on a Customer Data Set            ###########
##############################################################################
...
"""
    As you can see, Address in this dataset is a categorical variable. k-means 
    algorithm isn't directly applicable to categorical variables because 
...
"""
    ...
    would be the same as guessing that each customer group would have certain 
    age, income, education, etc, with multiple tests and experiments. However, 
...
# Making it a 3D plot on 3 variables
...
"""
    ...
    other demographically. Now we can create a profile for each group, 
